if GetLocale() == "deDE" then
  ...
  BIDSPECCHANGED = "Spec change was Accepted.",
    ...
    CulteDKPSCALESIZETTDESC = "Maßstab des CulteDKP-Fensters. Klicken Sie auf \"Save Settings\" (Einstellungen speichern), um die Größe auf den eingestellten Wert zu ändern.",
    CulteDKPSCALESIZETTWARN = "Möglicherweise ist ein / reload nach dem Speichern erforderlich, wenn ein anderes Addon verwendet wird, das die Skalierung der Benutzeroberfläche ändert (z. B. TukUI, ElvUI usw.).",
    MORE = "Mehr",
    ...
    OUTOFDATE = "veraltet",
    OUTOFDATEANNOUNCE = "Ihre Version von CulteDKP ist veraltet. Bitte aktualisieren Sie Curse / Twitch oder WoWInterface, um sicherzustellen, dass keine Kompatibilitätsprobleme vorliegen.",
    ...
    TOTALCulteDKPUSERS = "Gesamtzahl der CulteDKP-Benutzer",
    ...
    MIGRATIONDETECTED     = "CulteDKP hat ein aktives MonolithDKP-Addon entdeckt.|n|nMöchten Sie die aktuellen Tabellen und Einstellungen zu CulteDKP migrieren?",
    MIGRATIONTEAM         = "CulteDKP hat ein aktives MonolithDKP-Addon entdeckt.|n|nMöchten Sie die aktuellen Tabellen und Einstellungen|nals NEUES TEAM für deine aktuelle GILDE|nzu CulteDKP migrieren?",
    MIGRATIONUNAVAILABLE  = "Bitte deaktivieren Sie MonolithDKP und laden Sie das UI (/reload) neu, wenn Sie mit CulteDKP fortfahren möchten.",
    MIGRATIONCONFIRM      = "Dadurch werden Ihre bestehenden CulteDKP-Tabellen und Einstellungen überschrieben.|n|n Wollen Sie fortfahren?",
    MIGRATIONCANCELED     = "Migration abgebrochen.|n|nBitte deaktivieren Sie MonolithDKP und laden Sie die Benutzeroberfläche neu (/reload), wenn Sie mit CulteDKP fortfahren möchten, ohne Ihre aktuellen Tabellen und Einstellungen zu verwenden.",
