...
core.ZoneList = {
  ...
  "The Sunwell", -- 16
  "Ulduar", --17
  "The Obsidian Sanctum", --18
  "The Eye of Eternity", --19
...
core.L = {
  ...
  BIDSPECCHANGED = "Spec change was Accepted.",
  ...
  FOROFFSPEC = "for items not for you current spec (E.G. Healing gear for the Tank)",
  ...
  MINUTE = "minute",
  MINUTES = "minutes",
  CulteDKPSCALESIZE = "CulteDKP Scale Size",
  CulteDKPSCALESIZETTDESC = "Scale of the CulteDKP window. Click \"Save Settings\" to change size to set value.",
  CulteDKPSCALESIZETTWARN = "May require a /reload after saving if another Addon is used that modifies UI scales (ex. TukUI, ElvUI etc...)",
  MORE = "more",
  ...
  OUTOFDATEANNOUNCE = "Your version of CulteDKP is out-of-date. Please update on Curse/Twitch or WoWInterface to ensure there are no compatibility issues.",
  ...
  TOTALCulteDKPUSERS = "Total CulteDKP Users",
  ...
  SUBMITBID = "Submit Bid MS",
  SUBMITBIDOS = "Submit Bid OS",
  ...
  PLEASEVALIDATE = "Invalid entries were removed. Please validate your tables. (In the right click co.Text menu on the DKP table)",
  ...
  VALIDATEWARN = "This will recalculate all players dkp, lifetime earned and lifetime spent based on their complete history. Make sure to back up your saved variables file in the event the result is improper due to missing history entries. You should reset previous dkp (co.Text menu > select all > reset previous dkp) for all players prior to running so you can see how much they changed. Would you like to continue?",
  PASS = "Pass",

  MIGRATIONDETECTED     = "CulteDKP has detected an active MonolithDKP addon.|n|nDo you want to migrate its current tables and settings to CulteDKP?",
  MIGRATIONTEAM         = "CulteDKP has detected an active MonolithDKP addon.|n|nDo you want to migrate its current tables|nas a NEW TEAM for your current GUILD|nto CulteDKP?",
  MIGRATIONUNAVAILABLE  = "Please disable MonolithDKP and /reload the UI if you want to continue with CulteDKP.",
  MIGRATIONCONFIRM      = "This will overwrite your existing CulteDKP tables and settings.|n|nDo you want to continue?",
  ...
  MIGRATIONCOMPLETED    = "Migration complete.|n|nPlease disable MonolithDKP and /reload the UI.",
    ...
    CHANGELOG3 = "",
    CHANGELOG4 = "In progress : Background, all menus don't work",
    CHANGELOG5 = "",
    CHANGELOG6 = "",
