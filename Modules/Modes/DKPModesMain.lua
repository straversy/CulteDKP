...
function CulteDKP:DKPModes_Main()
  ...
  f.DKPModesMain.ModeDescription:SetFontObject("CulteDKPSmallLeft")
  ...
  --f.DKPModesMain.ModesDropDown = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f.DKPModesMain, "CulteDKPUIDropDownMenuTemplate")
  f.DKPModesMain.ModesDropDown = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f.DKPModesMain);
  ...
  f.DKPModesMain.ModeHeader:SetFontObject("CulteDKPSmallLeft")
  f.DKPModesMain.ModeHeader:SetText(L["DKPMODES"])

  -- Rounding DROPDOWN box 
  --f.DKPModesMain.RoundDropDown = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f.DKPModesMain, "CulteDKPUIDropDownMenuTemplate")
  f.DKPModesMain.RoundDropDown = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f.DKPModesMain);
  ...
  f.DKPModesMain.RoundHeader:SetFontObject("CulteDKPSmallLeft")
  f.DKPModesMain.RoundHeader:SetText(L["DKPROUNDING"])

  -- MAX Bid button behavior
  --f.DKPModesMain.MaxBidBehaviorDropDown = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f.DKPModesMain, "CulteDKPUIDropDownMenuTemplate")
  f.DKPModesMain.MaxBidBehaviorDropDown = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f.DKPModesMain);
  ...
  f.DKPModesMain.MaxBidBehaviorHeader:SetFontObject("CulteDKPSmallLeft")
  ...
  -- AntiSnipe Option
    ...
    f.DKPModesMain.AntiSnipe:SetFontObject("CulteDKPSmallRight")
    ...
    f.DKPModesMain.AntiSnipe.Header:SetFontObject("CulteDKPNormalLeft");
  ...
  --f.DKPModesMain.ChannelsDropDown = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f.DKPModesMain, "CulteDKPUIDropDownMenuTemplate")
  f.DKPModesMain.ChannelsDropDown = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f.DKPModesMain);
  ...
  f.DKPModesMain.ChannelsHeader:SetFontObject("CulteDKPSmallLeft")
  ...
  --f.DKPModesMain.CostSelection = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f.DKPModesMain, "CulteDKPUIDropDownMenuTemplate")
  f.DKPModesMain.CostSelection = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f.DKPModesMain);
  ...
  f.DKPModesMain.CostSelectionHeader:SetFontObject("CulteDKPSmallLeft")
  ...
  if not core.DB.modes.Inflation then core.DB.modes.Inflation = 0 end
    ...
    f.DKPModesMain.Inflation:SetFontObject("CulteDKPSmallRight")
    ...
    f.DKPModesMain.Inflation.Header:SetFontObject("CulteDKPNormalLeft");
  ...
  --f.DKPModesMain.ZeroSumType = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f.DKPModesMain, "CulteDKPUIDropDownMenuTemplate")
  f.DKPModesMain.ZeroSumType = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f.DKPModesMain);
  -- Create and bind the initialization function to the dropdown menu
  ...
  f.DKPModesMain.ZeroSumTypeHeader:SetFontObject("CulteDKPSmallLeft")
  ...
  --f.DKPModesMain.ItemCostDropDown = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f.DKPModesMain, "CulteDKPUIDropDownMenuTemplate")
  f.DKPModesMain.ItemCostDropDown = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f.DKPModesMain);
  -- Create and bind the initialization function to the dropdown menu
  ...
  f.DKPModesMain.ItemCostHeader:SetFontObject("CulteDKPSmallLeft")
  ...
  f.DKPModesMain.SubZeroBidding.Text:SetFontObject("CulteDKPSmallLeft")
  ...
  f.DKPModesMain.SubZeroBidding:SetScript("OnClick", function(self)
    if self:GetChecked() == true then
      core.DB.modes.SubZeroBidding = true;
      CulteDKP:Print("Sub Zero Bidding |cff00ff00"..L["ENABLED"].."|r")
      f.DKPModesMain.AllowNegativeBidders:Show()
      f.DKPModesMain.AllowNegativeBidders:SetChecked(core.DB.modes.AllowNegativeBidders)
    else
      core.DB.modes.SubZeroBidding = false;
      CulteDKP:Print("Sub Zero Bidding |cffff0000"..L["DISABLED"].."|r")
  ...
  f.DKPModesMain.AllowNegativeBidders.Text:SetFontObject("CulteDKPSmallLeft")
  ...
  f.DKPModesMain.AllowNegativeBidders:SetScript("OnClick", function(self)
    if self:GetChecked() == true then
      ...
      CulteDKP:Print("Allow Negative Bidders |cff00ff00"..L["ENABLED"].."|r")
    else
      core.DB.modes.AllowNegativeBidders = false;
      CulteDKP:Print("Allow Negative Bidders |cffff0000"..L["DISABLED"].."|r")
    end
    PlaySound(808);
  end)
  ...
  ---
    ...
    ---
      ...
      f.DKPModesMain.RollContainer.Header:SetFontObject("CulteDKPLargeLeft");
    ...
    ---
      ...
      --f.DKPModesMain.RollContainer.RollBiddingModeDropdown = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f.DKPModesMain.RollContainer, "CulteDKPUIDropDownMenuTemplate")
      f.DKPModesMain.RollContainer.RollBiddingModeDropdown = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f.DKPModesMain.RollContainer);
    ...
    ---
      ...
      f.DKPModesMain.RollContainer.SubModeHeader:SetFontObject("CulteDKPSmallLeft")
    ...
    ---
      ...
      f.DKPModesMain.RollContainer.rollMin:SetFontObject("CulteDKPSmallRight")
    ...
    ---
      ...
      f.DKPModesMain.RollContainer.rollMin.Header:SetFontObject("CulteDKPNormalLeft");
      ...
      f.DKPModesMain.RollContainer.rollMin.Header:SetText(L["MIN"])
        ...
        f.DKPModesMain.RollContainer.dash:SetFontObject("CulteDKPLargeLeft");
      ...
      f.DKPModesMain.RollContainer.rollMax = CreateFrame("EditBox", nil, f.DKPModesMain.RollContainer, BackdropTemplateMixin and "BackdropTemplate" or nil)
        ...
        f.DKPModesMain.RollContainer.rollMax:SetFontObject("CulteDKPSmallRight")
        ...
        f.DKPModesMain.RollContainer.rollMax.Header:SetFontObject("CulteDKPNormalLeft");
        ...
        f.DKPModesMain.RollContainer.rollMin.perc:SetFontObject("CulteDKPSmallLeft");
        ...
        f.DKPModesMain.RollContainer.rollMax.perc:SetFontObject("CulteDKPSmallLeft");
        ...
        f.DKPModesMain.RollContainer.UsePerc.Text:SetFontObject("CulteDKPSmallLeft")
      ...
      if WOW_PROJECT_ID == WOW_PROJECT_CLASSIC then
        ...
        f.DKPModesMain.RollContainer.AddMax:SetFontObject("CulteDKPSmallRight")
        ...
        f.DKPModesMain.RollContainer.AddMax.Header:SetFontObject("CulteDKPSmallRight");
      ...
      ---
        ...
        f.DKPModesMain.RollContainer.maxKarma:SetFontObject("CulteDKPSmallRight")
        ...
        f.DKPModesMain.RollContainer.maxKarma.Header:SetFontObject("CulteDKPSmallRight");
  ...
  f.DKPModesMain.BroadcastSettings:SetScript("OnClick", function()
    ...
    StaticPopupDialogs["SEND_MODES"] = {
      ...
      OnAccept = function()
        ...
        CulteDKP.Sync:SendData("CDKPDKPModes", temptable1)
        CulteDKP:Print(L["DKPMODESENTCONF"])
        local temptable2 = {}
              table.insert(temptable2, core.DB.MinBidBySlot)
              table.insert(temptable2, CulteDKP:FormatPriceTable())
              CulteDKP.Sync:SendData("CDKPMinBid", temptable2)
        local temptable3 = {}
              table.insert(temptable3, core.DB.MaxBidBySlot)
              table.insert(temptable3, CulteDKP:GetTable(CulteDKP_MaxBids, true))
              CulteDKP.Sync:SendData("CDKPMaxBid", temptable3)
      end,
      timeout = 0,
      whileDead = true,
      hideOnEscape = true,
