...
local function GenerateDKPTables(table, format)
	...
	if format == "HTML" then
		if table == CulteDKP:GetTable(CulteDKP_DKPTable, true) then
			...
			for i=1, #CulteDKP:GetTable(CulteDKP_DKPTable, true) do
				ExportString = ExportString.."      <div class=\"divTableRow\">\n         <div class=\"divPlayer\">"..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].player.."</div>\n         <div class=\"divClass\" style=\"width: 150px;\"><img src=\"https://wow.zamimg.com/images/wow/icons/large/classicon_"..strlower(CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].class)..".jpg\" height=\"24\" width=\"24\" /></div>\n         <div class=\"divDKP\">"..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].dkp.."</div>\n      </div>\n"
			end

			ExportString = ExportString.."   </div>\n</div>\n</div>"
		elseif table == CulteDKP:GetTable(CulteDKP_DKPHistory, true) then
			local numrows;

			if #CulteDKP:GetTable(CulteDKP_DKPHistory, true) > 200 then
				numrows = 200;
			else
				numrows = #CulteDKP:GetTable(CulteDKP_DKPHistory, true)
			end
			...
			for i=1, numrows do
				ExportString = ExportString.."      <div class=\"divTableRow\">\n         <div class=\"divPlayer\" style=\"font-size: 0.7em; width: 71%;\">"..gsub(CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].players, ",", ", ").."</div>\n         <div class=\"divClass\" style=\"width: 4%;\">"..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].dkp.."</div>\n         <div class=\"divDKP\" style=\"width: 25%; font-size: 0.7em;\">"..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].reason.."<br />("..date("%m/%d/%y %H:%M:%S", CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].date)..") </div>\n      </div>\n"
			end
			ExportString = ExportString.."   </div>\n</div>\n</div>"

		elseif table == CulteDKP:GetTable(CulteDKP_Loot, true) then
			local numrows;
			...
			if #CulteDKP:GetTable(CulteDKP_Loot, true) > 200 then
				numrows = 200;
			else
				numrows = #CulteDKP:GetTable(CulteDKP_Loot, true)
			end
			...
			for i=1, numrows do
				local cur = CulteDKP:GetTable(CulteDKP_Loot, true)[i].loot
				local itemNumber = strsub(cur, string.find(cur, "Hitem:")+6, string.find(cur, ":", string.find(cur, "Hitem:")+6)-1)
				ExportString = ExportString.."      <div class=\"divTableRow\">\n         <div class=\"divPlayer\" style=\"width: 40%;\"><a href=\""..baseUrl.."item="..itemNumber.."\" data-wowhead=\"item="..itemNumber.."\"></a> ("..CulteDKP:GetTable(CulteDKP_Loot, true)[i].cost.." DKP)</div>\n         <div class=\"divClass\" style=\"width: 20%;\">"..CulteDKP:GetTable(CulteDKP_Loot, true)[i].player.."</div>\n         <div class=\"divDKP\" style=\"width: 40%; font-size: 0.7em;\">"..CulteDKP:GetTable(CulteDKP_Loot, true)[i].zone..": "..CulteDKP:GetTable(CulteDKP_Loot, true)[i].boss.."<br />("..date("%m/%d/%y %H:%M:%S", CulteDKP:GetTable(CulteDKP_Loot, true)[i].date)..") </div>\n      </div>\n"
			end
			ExportString = ExportString.."   </div>\n</div>\n</div>\n</html>"
		end
	elseif format == "CSV" then
		if table == CulteDKP:GetTable(CulteDKP_DKPTable, true) then
			...
			for i=1, #CulteDKP:GetTable(CulteDKP_DKPTable, true) do
				if i == #CulteDKP:GetTable(CulteDKP_DKPTable, true) then
					ExportString = ExportString..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].player..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].class..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].dkp..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].previous_dkp..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].lifetime_gained..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].lifetime_spent;
				else
					ExportString = ExportString..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].player..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].class..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].dkp..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].previous_dkp..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].lifetime_gained..","..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].lifetime_spent.."\n";
				end
			end
		elseif table == CulteDKP:GetTable(CulteDKP_DKPHistory, true) then
			...
			ExportString = Headers.."";
			for i=1, numrows do
				local PlayerString = strsub(CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].players, 1, -2)

				if i == numrows then
					ExportString = ExportString.."\""..PlayerString.."\""..","..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].dkp..","..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].date..",".."\""..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].reason.."\"";
				else
					ExportString = ExportString.."\""..PlayerString.."\""..","..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].dkp..","..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].date..",".."\""..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].reason.."\"".."\n";
				end
			end
		elseif table == CulteDKP:GetTable(CulteDKP_Loot, true) then
			...
			for i=1, numrows do
				...
				if i == numrows then
					ExportString = ExportString..CulteDKP:GetTable(CulteDKP_Loot, true)[i].player..",".."\""..itemName.."\""..","..itemNumber..",".."\""..CulteDKP:GetTable(CulteDKP_Loot, true)[i].zone.."\""..","..CulteDKP:GetTable(CulteDKP_Loot, true)[i].boss..","..CulteDKP:GetTable(CulteDKP_Loot, true)[i].date..","..CulteDKP:GetTable(CulteDKP_Loot, true)[i].cost;
				else
					ExportString = ExportString..CulteDKP:GetTable(CulteDKP_Loot, true)[i].player..",".."\""..itemName.."\""..","..itemNumber..",".."\""..CulteDKP:GetTable(CulteDKP_Loot, true)[i].zone.."\""..","..CulteDKP:GetTable(CulteDKP_Loot, true)[i].boss..","..CulteDKP:GetTable(CulteDKP_Loot, true)[i].date..","..CulteDKP:GetTable(CulteDKP_Loot, true)[i].cost.."\n";
				end
			end
	...
	elseif format == "XML" then
		if table == CulteDKP:GetTable(CulteDKP_DKPTable, true) then
			...
			for i=1, #CulteDKP:GetTable(CulteDKP_DKPTable, true) do
				ExportString = ExportString.."    <dkpentry>\n        <player>"..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].player.."</player>\n        <class>"..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].class.."</class>\n        <dkp>"..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].dkp.."</dkp>\n        <lifetimegained>"..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].lifetime_gained.."</lifetimegained>\n        <lifetimespent>"..CulteDKP:GetTable(CulteDKP_DKPTable, true)[i].lifetime_spent.."</lifetimespent>\n    </dkpentry>\n";
			end
		...
		elseif table == CulteDKP:GetTable(CulteDKP_DKPHistory, true) then
			...
			for i=1, numrows do
				local deletes;
				local deletedby;
				if CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].deletes == nil then 
					deletes = ''
				else
					deletes = CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].deletes
				end
	
				if CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].deletedby == nil then 
					deletedby = ''
				else
					deletedby = CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].deletedby
				end
	
				ExportString = ExportString.."    <historyentry>\n        <playerstring>"..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].players.."</playerstring>\n        <dkp>"..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].dkp.."</dkp>\n        <timestamp>"..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].date.."</timestamp>\n        <reason>"..CulteDKP:GetTable(CulteDKP_DKPHistory, true)[i].reason.."</reason>\n        <deletes>"..deletes.."</deletes>\n        <deletedby>"..deletedby.."</deletedby>\n    </historyentry>\n";
			end
		...
		elseif table == CulteDKP:GetTable(CulteDKP_Loot, true) then
			...
			for i=1, numrows do
				...
				local deletes;
				local deletedby;
				if CulteDKP:GetTable(CulteDKP_Loot, true)[i].deletes == nil then 
					deletes = ''
				else
					deletes = CulteDKP:GetTable(CulteDKP_Loot, true)[i].deletes
				end
	
				if CulteDKP:GetTable(CulteDKP_Loot, true)[i].deletedby == nil then 
					deletedby = ''
				else
					deletedby = CulteDKP:GetTable(CulteDKP_Loot, true)[i].deletedby
				end
	
				ExportString = ExportString.."    <lootentry>\n        <player>"..CulteDKP:GetTable(CulteDKP_Loot, true)[i].player.."</player>\n        <itemname>"..itemName.."</itemname>\n        <itemnumber>"..itemNumber.."</itemnumber>\n        <zone>"..CulteDKP:GetTable(CulteDKP_Loot, true)[i].zone.."</zone>\n        <boss>"..CulteDKP:GetTable(CulteDKP_Loot, true)[i].boss.."</boss>\n        <timestamp>"..CulteDKP:GetTable(CulteDKP_Loot, true)[i].date.."</timestamp>\n        <cost>"..CulteDKP:GetTable(CulteDKP_Loot, true)[i].cost.."</cost>\n        <deletes>"..deletes.."</deletes>\n        <deletedby>"..deletedby.."</deletedby>\n    </lootentry>\n";
			end
	...
	CulteDKPExportBoxEditBox:SetText(ExportString)
end

function CulteDKP:ExportBox_Show(text)
    if not CulteDKPExportBox then
        local f = CreateFrame("Frame", "CulteDKPExportBox", UIParent, BackdropTemplateMixin and "BackdropTemplate" or nil)
        f:SetPoint("CENTER")
        f:SetSize(700, 590)
        ...
        -- ScrollFrame
        local sf = CreateFrame("ScrollFrame", "CulteDKPExportBoxScrollFrame", CulteDKPExportBox, "UIPanelScrollFrameTemplate")
		...
		f.desc:SetFontObject("CulteDKPSmallLeft");
        ...
        -- EditBox
        local eb = CreateFrame("EditBox", "CulteDKPExportBoxEditBox", CulteDKPExportBoxScrollFrame, BackdropTemplateMixin and "BackdropTemplate" or nil)
        ...
        local rb = CreateFrame("Button", "CulteDKPExportBoxResizeButton", CulteDKPExportBox)
		...
		--f.FormatDropDown = CreateFrame("FRAME", "CulteDKPModeSelectDropDown", f, "CulteDKPUIDropDownMenuTemplate")
		f.FormatDropDown = LibDD:Create_UIDropDownMenu("CulteDKPModeSelectDropDown", f);
        ...
        f.GenerateDKPButton = CulteDKP:CreateButton("BOTTOMRIGHT", f, "BOTTOMRIGHT", -355, 20, "1) "..L["GENDKPTABLE"]);
		f.GenerateDKPButton:SetSize(150, 24)
		f.GenerateDKPButton:SetScript("OnClick", function()
			if CurFormat then
				GenerateDKPTables(CulteDKP:GetTable(CulteDKP_DKPTable, true), CurFormat)
			else
				StaticPopup_Show ("NO_FORMAT")
			end
		end)

		f.GenerateDKPHistoryButton = CulteDKP:CreateButton("BOTTOMRIGHT", f, "BOTTOMRIGHT", -200, 20, "2) "..L["GENDKPHIST"]);
		f.GenerateDKPHistoryButton:SetSize(150, 24)
		f.GenerateDKPHistoryButton:SetScript("OnClick", function()
			if CurFormat then
				GenerateDKPTables(CulteDKP:GetTable(CulteDKP_DKPHistory, true), CurFormat)
			else
				StaticPopup_Show ("NO_FORMAT")
			end
		end)

		f.GenerateDKPLootButton = CulteDKP:CreateButton("BOTTOMRIGHT", f, "BOTTOMRIGHT", -45, 20, "3) "..L["GENLOOTHIST"]);
		f.GenerateDKPLootButton:SetSize(150, 24)
		f.GenerateDKPLootButton:SetScript("OnClick", function()
			if CurFormat then
				GenerateDKPTables(CulteDKP:GetTable(CulteDKP_Loot, true), CurFormat)
			else
				StaticPopup_Show ("NO_FORMAT")
			end
		end)

		f.SelectAllButton = CulteDKP:CreateButton("BOTTOMLEFT", f, "BOTTOMLEFT", 45, 20, L["SELECTALL"]);
		f.SelectAllButton:SetSize(100, 20)
		f.SelectAllButton:SetScript("OnClick", function()
			CulteDKPExportBoxEditBox:HighlightText()
			CulteDKPExportBoxEditBox:SetFocus()
		end)
    end
...
function CulteDKP:ToggleExportWindow()
	CulteDKP:ExportBox_Show()
end
